...
with open(output_file, 'w+') as ffile:
    ...
    ffile.write('ANSWER: If aggregating data from more than one source or if the values has been manually updated by people,\n')
    ffile.write("it's importante to certify that all values are consistent with the database datatypes expected. Also, it's\n")
    ...
    ffile.write("it contains only floats and integers and apply some standardization rule in number of digits and decimals\n")
    ffile.write("before insert into a database.\n\n")
